                        ...
                        <div class="panel-body">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade active in" id="home">
                                    ...
                                    <p>Como todo sistema que se preze, os dados informados são apresentados de forma analítica para o usuário final. Em nosso caso, um resumo de últimas cotações e um gráfico comparativo.</p>
                                    ...
                                    <p>Caso o senhor possua uma instancia do MySql, os scripts de criação estão na pasta 'scripts_banco'.</p>
